...
`muse-occupied-plain-80x24.txt` are `tests/fixtures/muse-composer/muse-idle-composer.esc`
(sha256 `e086277a93f190367f8d6328a7d4b105e47a5fe795d3ed389f9b708bd4ae1055`) and
`muse-occupied-composer.esc` (sha256
`8536d03c560fb380b408bae27548b8070f64513fad160e1e43efc44bbbde0b47`) with
`sed -E 's/\x1b\[[0-9;]*[A-Za-z]//g'` stripping only the SGR sequences that
`-p` omits. `opencode-composed-plain-80x24.txt` is the same strip of
`tests/fixtures/opencode-composer/opencode-composed-frame.esc` (sha256
`581d6b2cdb67565946fb0b9c1f35e49ed6c65d7fa8db4aaa0b9fb8320d54de82`). The
strips have no other edit; the transcript text above each composer is kept as
the anchor-negative evidence the parsers are pinned against.
