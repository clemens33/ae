...
They cover independent unknown fields (a claude suffix that is no effort voids
the model: `claude-known-model-unknown-effort.txt`), changed effort, historical-vs-current
