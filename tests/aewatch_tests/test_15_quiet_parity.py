    ...
    return _base(
        ...
        [
            ...
            {"epoch": _E + 100, "now": _iso(_E + 100), "captures": {_PANE: "inbound"},
             "events": [{"session": "work", "event": {"ts": _iso(_E + 100), "actor": "claude:lead",
                         "action": "send", "target": _AGENT, "summary": "ping"}}]},
    ...
    return _base(
        ...
        [
            ...
            {"epoch": _E + 200, "now": _iso(_E + 200), "captures": {_PANE: "echo2"},
             "events": [{"session": "work", "event": _decl(_E + 200, "blocked", "blocked on infra")}]},
