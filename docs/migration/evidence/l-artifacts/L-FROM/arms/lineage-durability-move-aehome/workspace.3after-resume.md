...
Session: child
Origin: /private/tmp/aelx/L-FROM/lineage-durability-move-aehome/w
Directory: /private/tmp/aelx/L-FROM/lineage-durability-move-aehome/w
Mode: local
...
- ID: 9a325c6e-8f5c-4cfa-9591-69372cd9cab6
- Digest: /tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/archive/9a325c6e-8f5c-4cfa-9591-69372cd9cab6/digest.md
- Handover entries: 0
- Pending requests: 0
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/send "<agent_name>" "your message"
```

Ask another agent a question and require a reply:
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/ask <agent_name> "your question"
```

Request a critical review:
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/review <agent_name> "review request"
```

Reply to a logged request by request id:
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/reply <request_id> "your reply"
```

Inspect request state without peeking panes:
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/requests
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/requests inbox
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/state working "starting on X"
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/state waiting-user "need clarification on Y"
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/state blocked "waiting for codex review on req-Z"   # reason required
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/state done "shipped X"
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/state                                                # print current state
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/memo add "important shared fact"
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/memo add --topic arch "we chose SQLite over Postgres"
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/memo read
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/memo read --topic arch
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/memo tail 5
```

Memo entries are append-only and stored in `/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/memo.tsv`. Use memo for durable shared context, not full chat transcripts.
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/goal                       # show the current session goal
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/goal "ship the PR for X"   # set it
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/goal --clear               # remove it
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/send "<their_agent_name>" "your reply"
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/say "done — the menu is live, tested end to end"
echo "a longer, multi-line reply" | /tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/say   # stdin for long text
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/peek <agent_name> [lines]
```
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/peak <agent_name> [lines]
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/agents
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/focus <agent_name>
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/interrupt <agent_name> [message]
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/spawn <alias>:<name> [prompt]
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/retire <agent_name|pane_id>
```
...
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/peek @other-session:claude:lead 20
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/send @other-session:codex:reviewer "check the API"
```

List all agents across all running sessions:
```bash
/tmp/aelx/L-FROM/lineage-durability-move-aehome/h2/.ae/sessions/child/agents --all
```
