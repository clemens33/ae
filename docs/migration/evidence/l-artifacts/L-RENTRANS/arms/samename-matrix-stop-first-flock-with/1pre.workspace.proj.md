...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/send "<agent_name>" "your message"
```

Ask another agent a question and require a reply:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/ask <agent_name> "your question"
```

Request a critical review:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/review <agent_name> "review request"
```

Reply to a logged request by request id:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/reply <request_id> "your reply"
```

Inspect request state without peeking panes:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/requests
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/requests inbox
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/state working "starting on X"
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/state waiting-user "need clarification on Y"
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/state blocked "waiting for codex review on req-Z"   # reason required
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/state done "shipped X"
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/state                                                # print current state
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/memo add "important shared fact"
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/memo add --topic arch "we chose SQLite over Postgres"
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/memo read
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/memo read --topic arch
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/memo tail 5
```

Memo entries are append-only and stored in `/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/memo.tsv`. Use memo for durable shared context, not full chat transcripts.
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/goal                       # show the current session goal
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/goal "ship the PR for X"   # set it
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/goal --clear               # remove it
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/send "<their_agent_name>" "your reply"
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/say "done — the menu is live, tested end to end"
echo "a longer, multi-line reply" | /tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/say   # stdin for long text
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/peek <agent_name> [lines]
```
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/peak <agent_name> [lines]
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/agents
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/focus <agent_name>
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/interrupt <agent_name> [message]
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/spawn <alias>:<name> [prompt]
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/retire <agent_name|pane_id>
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/peek @other-session:claude:lead 20
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/send @other-session:codex:reviewer "check the API"
```

List all agents across all running sessions:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-stop-first-flock-with/h/.ae/sessions/proj/agents --all
```
