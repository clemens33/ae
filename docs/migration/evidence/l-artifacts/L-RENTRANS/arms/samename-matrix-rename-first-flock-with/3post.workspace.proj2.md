...
Session: proj2
Origin: /private/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/w
Directory: /private/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/w
Mode: local
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/send "<agent_name>" "your message"
```

Ask another agent a question and require a reply:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/ask <agent_name> "your question"
```

Request a critical review:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/review <agent_name> "review request"
```

Reply to a logged request by request id:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/reply <request_id> "your reply"
```

Inspect request state without peeking panes:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/requests
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/requests inbox
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/state working "starting on X"
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/state waiting-user "need clarification on Y"
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/state blocked "waiting for codex review on req-Z"   # reason required
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/state done "shipped X"
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/state                                                # print current state
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/memo add "important shared fact"
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/memo add --topic arch "we chose SQLite over Postgres"
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/memo read
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/memo read --topic arch
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/memo tail 5
```

Memo entries are append-only and stored in `/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/memo.tsv`. Use memo for durable shared context, not full chat transcripts.
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/goal                       # show the current session goal
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/goal "ship the PR for X"   # set it
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/goal --clear               # remove it
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/send "<their_agent_name>" "your reply"
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/say "done — the menu is live, tested end to end"
echo "a longer, multi-line reply" | /tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/say   # stdin for long text
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/peek <agent_name> [lines]
```
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/peak <agent_name> [lines]
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/agents
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/focus <agent_name>
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/interrupt <agent_name> [message]
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/spawn <alias>:<name> [prompt]
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/retire <agent_name|pane_id>
```
...
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/peek @other-session:claude:lead 20
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/send @other-session:codex:reviewer "check the API"
```

List all agents across all running sessions:
```bash
/tmp/aelx/L-RENTRANS/samename-matrix-rename-first-flock-with/h/.ae/sessions/proj2/agents --all
```
