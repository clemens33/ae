...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/send "<agent_name>" "your message"
```

Ask another agent a question and require a reply:
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/ask <agent_name> "your question"
```

Request a critical review:
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/review <agent_name> "review request"
```

Reply to a logged request by request id:
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/reply <request_id> "your reply"
```

Inspect request state without peeking panes:
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/requests
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/requests inbox
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/state working "starting on X"
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/state waiting-user "need clarification on Y"
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/state blocked "waiting for codex review on req-Z"   # reason required
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/state done "shipped X"
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/state                                                # print current state
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/memo add "important shared fact"
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/memo add --topic arch "we chose SQLite over Postgres"
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/memo read
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/memo read --topic arch
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/memo tail 5
```

Memo entries are append-only and stored in `/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/memo.tsv`. Use memo for durable shared context, not full chat transcripts.
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/goal                       # show the current session goal
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/goal "ship the PR for X"   # set it
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/goal --clear               # remove it
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/send "<their_agent_name>" "your reply"
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/say "done — the menu is live, tested end to end"
echo "a longer, multi-line reply" | /tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/say   # stdin for long text
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/peek <agent_name> [lines]
```
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/peak <agent_name> [lines]
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/agents
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/focus <agent_name>
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/interrupt <agent_name> [message]
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/spawn <alias>:<name> [prompt]
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/retire <agent_name|pane_id>
```
...
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/peek @other-session:claude:lead 20
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/send @other-session:codex:reviewer "check the API"
```

List all agents across all running sessions:
```bash
/tmp/aelx/L-RENTRANS/rename-effects/h/.ae/sessions/projx/agents --all
```
