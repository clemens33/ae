...
CRIT-ASSIGN: SC-012b | H-HELPER | top-level -h/--help probe: capture stdout/stderr/rc for ae -h, ae --help, and ae help separately alongside one another (one dispatch branch, ae:16841-16843; seats compare)
