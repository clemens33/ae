...
MUTATIONS = [
    ...
    ("LETTERS", "a CRITICAL row carrying an invented criterion letter (colead's control)",
     lambda s: s.replace("- SC-400d — CRITICAL(C,D)", "- SC-400d — CRITICAL(C,E)", 1), None),
    ("LETTERS", "a CRITICAL row with no letter set at all (colead's control)",
     lambda s: s.replace("- SC-400d — CRITICAL(C,D)", "- SC-400d — CRITICAL", 1), None),
    ("LETTERS", "a CRITICAL row repeating a criterion letter",
     lambda s: s.replace("- SC-400d — CRITICAL(C,D)", "- SC-400d — CRITICAL(C,C,D)", 1), None),
