...
- **A session's LOOK is session-scoped, and it has three writers with one job each.**
  ...
  menu. The picker carries the clicking client explicitly, and a row switches to the captured
